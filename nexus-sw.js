...
// v16.5.0 (2026-08-17) — 홈 자산 그래프 증권사 스타일(D안).
//   NAV 선 + 우측 $눈금(K 축약) + 가로 그리드 + 드래그 십자선(상단 캡슐) +
//   원장 실체결 마커(매수 ▲ / 매도 ▼, 탭하면 달력 카드) + 하단 손익 스트립.
//   기간 4탭 집계 단위·자체 대사는 v16.4.1 그대로. PC 원본과 동시 diff 이식.
const CACHE_VERSION = 'v16.5.0';
